...
class _TasksOverviewScreenState extends State<TasksOverviewScreen>
  ...
  void _fetchMyAssignedTasks() async {
                        ...
                        child: LayoutBuilder(
                          builder: (context, constraints) {
                            ...
                            return AspectRatio(
                              ...
                              child: Cards(
                                thisTask: Future.value(assignedTask
                                    .task), // Corrected Future.value
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _selectedCategory == null
              ? "No Filter"
              : _selectedCategory!
                  .name, // Set default value if no category is selected
                          ...
                          Row(
                            children: [
                              IconButton(
                                icon: const Icon(Icons.sort),
                                onPressed:
                                    _rotateSortOption, // Rotate through sort options
                              ),
                              Text("Sort by $_sortOption"),
                            ],
                          ),
                            ...
                            if (snapshot.connectionState ==
                              ...
                              return LayoutBuilder(
                                builder: (context, constraints) {
                                  ...
                                  final aspectRatio = 140 /
                                      200; // Maintain the card's aspect ratio
                                  ...
                                  return GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return GestureDetector(
                                        onTap: () =>
                                            _showYourTaskAction(context, task),
                                        child: Cards(
                                          ...
                                          size: Size.small,
                                          heightBig:
                                              200, // This height works with the aspect ratio
                                        ),
                                      );
                                    },
                                  );
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _selectedUserId == null
                            ? const Center(
                                child:
                                    Text("Select a user to view their tasks."))
                            : FutureBuilder<List<AssignedTask>>(
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState ==
                                    ...
                                    final tasks = _applySortingAndFiltering(
                                        snapshot.data!);
                                    return LayoutBuilder(
                                      builder: (context, constraints) {
                                        final crossAxisCount =
                                            (constraints.maxWidth ~/ 200).clamp(
                                                2, 4); // Min 2, Max 4 columns
                                        final aspectRatio = 140 /
                                            200; // Maintain card aspect ratio
...
void showConfirmationDialog(BuildContext context, AssignedTask assignedTask,
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          ...
                          showConfirmationDialog(
                              context, assignedTask, currUser, fnCallback);
                        },
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      ...
      return Dialog(
        ...
        insetPadding:
            EdgeInsets.symmetric(horizontal: 16), // Reduced side padding
        child: Container(
          constraints: BoxConstraints(
            maxWidth: screenWidth * 0.9, // Ensure compact width
            maxHeight:
                screenHeight * 0.7, // Height limited to 70% of the screen
          ),
          child: Padding(
                    ...
                    Row(
                      ...
                      children: [
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                color:
                                    Colors.black87, // High contrast text color
                              ),
                            ),
                            SizedBox(height: 8),
                            Container(
                              width:
                                  140, // Fixed width for consistent aspect ratio
                              height:
                                  200, // Fixed height for consistent aspect ratio
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    ...
                                    blurRadius: 8,
                                    offset:
                                        Offset(2, 4), // Subtle shadow for depth
                                  ),
                                ],
                              ),
                              child: Cards(
                        ...
                        Column(
                          children: [
                            SizedBox(
                                height: 16), // Add space to align with cards
                            Icon(
                              Icons.swap_horiz,
                              size: 36,
                              color: Colors.indigo,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: selectedTask != null
                                  ? Cards(
                                      thisTask:
                                          Future.value(selectedTask!.task),
                                      sState: SmallState.info,
                                      bState: BigState.info,
                                      size: Size.small,
                                      heightBig: 200, // Adjusted heightBig
                                  ...
                                  : Center(
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors
                                              .black54, // Better contrast for readability
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: FutureBuilder<List<AssignedTask>>(
                                    future: AssignedTask.getTasksForUser(
                                        currUser.userId),
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState ==
                                          ConnectionState.waiting) {
                                                ...
                                                onTap: () {
                                                  setState(() {
                                                    if (selectedTask == task) {
                                                      selectedTask =
                                                          null; // Deselect the card
                                                    } else {
                                                      selectedTask =
                                                          task; // Select the card
                                                    }
                                                  });
                                                },
                                                child: Container(
                                                  width:
                                                      140, // Fixed width for aspect ratio
                                                  height:
                                                      200, // Fixed height for aspect ratio
